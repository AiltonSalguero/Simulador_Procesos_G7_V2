    ...
    public static void main(String[] args) {
        ...
        for(Politica politica:politicasSistema){
            ...
            while(procesosSinTerminar){
                ...
                seCreoHijoTotalBurstTimeHijo=PlanificadorLargoPlazo.CapturarProcesosNuevos
                    (procesosPadres, procesosHijos, procesosNuevos, procesosSistema, tiempo, 
